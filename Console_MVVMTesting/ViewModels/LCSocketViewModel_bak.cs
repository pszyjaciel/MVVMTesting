...
{
    public class LCSocketViewModel_bak : ObservableObject
    {
        ...
        public LCSocketViewModel_bak(ILoggingService loggingService, IMessenger messenger, EastTesterViewModel etvm)
        {
            _log = loggingService;
